...
import { Home, History, Settings, Plus, LogOut, User, Users } from 'lucide-react';
...
export function Header() {
  ...
  return (
    <>
      ...
      {/* Navigation */}
      {user && (
        <nav className="fixed bottom-0 left-0 right-0 bg-card/98 backdrop-blur-md border-t border-border/50 z-50 safe-area-inset-bottom shadow-lg">
          <div className="container mx-auto px-2 py-3">
            <div className="grid grid-cols-5 gap-1 max-w-2xl mx-auto">
              ...
              <NavLink to="/conexoes" icon={Users} label="Conexões" />
